...
--save_dir ../MVFI_output/checkpoints/ucf_cslstm_20210126_1_6 \
--gen_frm_dir ../MVFI_output/results/ucf_cslstm_20210126_1_6 \
--log_dir ../tensorflow/logs/ucf_cslstm_20210126_1_6 \
--model_name Bi-LSTM3 \
--seq_length 7 \
--img_size 224 \
--img_channel 3 \
